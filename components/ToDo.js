        ...
        <div className='my-2 font-bold text-3xl'>
            ...
            <section className="text-gray-600 body-font">
                <div className="relative flex-grow w-full">
                    ...
                    <input onChange={onChange} type="text" value={todo.title} id="title" name="title" className=" bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                </div>
                <div className="relative flex-grow w-full">
                    <label for="email" className="leading-7 text-sm text-gray-600">Task Category</label> <br></br>
                    {
                        categories.map((item, index) => {
                            ...
                            return (<div className="flex items-center" key={index}>
                                <input onChange={onChange} id="default-radio-1" type="radio" value={item} name="desc" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
